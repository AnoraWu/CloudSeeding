...
# 保存文件名
result_file = '微博数据_人工增雨_19-21.csv'
#  搜索关键词
keyword = '人工增雨'
# 最大页
max_page = 50
# cookie值 改为自己登录微博账号之后的cookie
COOKIE_PC = 'SCF=AlBMOReBUvICT5u0wVPbCLnXr2HYblJrgoNylYIMlgJu2NRDAjNgGf4MrN_kgA-sB0O7Trf6H-sOsaASpA5rq4A.; XSRF-TOKEN=HofqIXwlGCm5-nRAVd18eZBe; ALF=1729874967; SUB=_2A25L8E9HDeRhGeFH71oY8inIzD-IHXVojM6PrDV8PUJbkNB-LUjTkW1Newwp33rczDBbZ24pHKN826m26oicfVCl; SUBP=0033WrSXqPxfM725Ws9jqgMF55529P9D9W5QukEsSOyNmALA94RNE55o5JpX5KMhUgL.FoM4Shn4eoMXS0e2dJLoIEXLxKqL1hnL1K2LxKML1h.LBo.LxK-L1K.LBoqLxKqL1KqLB-qLxK-L1-qLB.2t; ariaDefaultTheme=default; ariaFixed=true; ariaReadtype=1; ariaMouseten=null; ariaStatus=false; _s_tentry=-; Apache=2579903780436.4746.1727445568781; SINAGLOBAL=2579903780436.4746.1727445568781; ULV=1727445568811:1:1:1:2579903780436.4746.1727445568781:; WBPSESS=NyAZoRytRkRkEvTdNBasMCpcF454xBS481a8B0WCfxGrh0SiHHcZUKE2mCIAo_dIFlco4oRemv5tBGXRY-OG8esYFdyMHXLRo03K5r9Ai27qaM9cBNbY4Xrv3l7G_AYk4DXpqb3OFDjtJUL2_cVhoA=='
# 设置起始时间
start_time = datetime.datetime(2019, 1, 1, 0)
end_time = datetime.datetime(2021, 12, 31, 0)
